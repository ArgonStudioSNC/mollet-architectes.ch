<div class="reveal full without-overlay" id="reveal-gallery" data-reveal data-animation-in="fade-in fast" data-animation-out="fade-out fast">
    <div class="orbit" role="region" aria-label="Galerie photo du projet" data-orbit data-options="autoPlay: false; bullets: false; prevClass: my-orbit-previous; nextClass: my-orbit-next;" data-use-m-u-i="false">
            ...
            <ul class="cell auto orbit-container">
                ...
                <li class="orbit-slide">
                    <figure class="orbit-figure grid-y">
                        <div class="cell auto">
                            <img class="centered" src="{{ asset('storage/projects/'.$project->slug.'/mollet-architectes_'.$project->slug.'_'.$figures[$i]['img']) }}" alt="IMAGE {{ $figures[$i]['img'] }}">
                        </div>
